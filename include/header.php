<header class="text-gray-600 body-font">
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      ...
      <span class="ml-3 text-xl">Prem Software</span>
    </a>
    <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
      <a href="index.php" class="mr-5 hover:text-gray-900">Home</a>
      <a href="software.php" class="mr-5 hover:text-gray-900">Software</a>
      <a href="development.php" class="mr-5 hover:text-gray-900">Development</a>
      <a href="about.php" class="mr-5 hover:text-gray-900">About</a>
      <a href="contact.php" class="mr-5 hover:text-gray-900">Contact</a>
    </nav>

    <!-- ✔️ ONLY THIS CHANGE (onclick added) -->
