...
<head>
  ...
  <title>Prem Software Solution Pvt Ltd</title>
  <script src="https://cdn.tailwindcss.com"></script>
</head>

<body>
  <!-- header section yaha se chalu hua hai -->
<?php include 'include/header.php'; ?>

  <section class="text-gray-600 body-font">
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Prem Software Solution Pvt Ltd
          <br class="hidden lg:inline-block">Website Designing And Software Development Company
        </h1>
      ...
      <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
        <img class="object-cover object-center rounded" alt="hero" src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1172&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D/720x600">
      </div>
    </div>
  </section>
  <section class="text-gray-600 body-font">
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
        <img class="object-cover object-center rounded" alt="hero" src="https://plus.unsplash.com/premium_photo-1661877737564-3dfd7282efcb?q=80&w=1200&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D/720x600">
      </div>
      <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">This company has approved by Prem Enterprise Pvt Ltd
          <br class="hidden lg:inline-block">it is very awesome company
        </h1>
    ...
    <div class="container px-5 py-24 mx-auto flex flex-wrap">
      <div class="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
        <div class="w-full sm:p-4 px-4 mb-6">
          <h1 class="title-font font-medium text-xl mb-2 text-gray-900">Laptop & Computer Formatting & Installation Service</h1>
          <div class="leading-relaxed">Hum professional laptop aur computer formatting & installation service provide karte hain jisme system ko fresh, fast aur error-free banaya jata hai. Complete formatting, clean partition setup, Windows installation (7/8/10/11), saare essential drivers (Wi-Fi, audio, display), latest updates, antivirus, aur basic software ka full setup kiya jata hai. Agar aapka system slow chal raha ho, hang karta ho, virus se affected ho ya boot problem de raha ho, to hum usse bilkul new jaisa smooth aur fast perform karne layak bana dete hain. Quick, reliable aur affordable computer formatting and installation solution available.</div>
        </div>
        <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
          <h2 class="title-font font-medium text-3xl text-gray-900">1.7M</h2>
          <p class="leading-relaxed">Users</p>
        </div>
        <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
          <h2 class="title-font font-medium text-3xl text-gray-900">98.8K</h2>
      ...
      <div class="lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
        <img class="object-cover object-center w-full h-full" src="https://images.unsplash.com/photo-1537498425277-c283d32ef9db?q=80&w=1178&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D/600x300" alt="stats">
      </div>
    </div>
  </section>
  <!-- footer start ho raha hai yaha se -->
