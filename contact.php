      ...
      <div class="lg:w-1/2 md:w-2/3 mx-auto">
        <div class="flex flex-wrap -m-2">
          ...
          <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
            <a class="text-indigo-500">nikeshkumar0147@email.com</a>
            <p class="leading-normal my-5">Prem Enterprise Pvt Ltd, Bhaluwahiya Chauk, Ramgarhwa,
              <br>Ramgarhwa, East Champaran, Bihar 845303
            </p>
